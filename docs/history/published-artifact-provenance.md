...
`main` as the only publish source is now a reaction — `scripts/check_publish_source.sh`, reached
...
This is the class `scripts/check_publish_source.sh` refuses. Run against a worktree at `f1dba52` it
