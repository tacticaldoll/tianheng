//! What more than one repository check shares, compiled into each that uses it: the readers of
//! `.github/workflows/ci.yml`, and the launcher the wrapper directions hand a broken stream with.
//!
