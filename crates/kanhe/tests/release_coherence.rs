...
/// a rule written afterwards would falsify the record rather than repair it.
#[test]
...
///
/// Measured on this repository: the `0.6.0` window's first change could not pass the Definition of Done until it
