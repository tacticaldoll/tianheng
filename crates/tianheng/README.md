...
| 渾儀 (semantic) | [`hunyi`](https://crates.io/crates/hunyi) | type exposure, impl locality, visibility, forbidden markers, `dyn` exposure (shape-only & named-operand), `impl Trait` existential exposure (AST/`syn`) |
