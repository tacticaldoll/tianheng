...
| 渾儀 (semantic) | [`hunyi`](https://crates.io/crates/hunyi) | type exposure, impl locality, visibility, forbidden markers, `dyn` & `impl Trait` (existential) exposure — each shape-only & named-operand (AST/`syn`) |
