...
- [x] 1.1 Specify that every bound enumerator consumes the canonical marker predicate.
- [x] 1.2 Specify the accepted bare singular forms and rejected near-misses.

## 2. Implementation

- [x] 2.1 Add a focused table for the canonical marker grammar.
- [x] 2.2 Delete the model's duplicate predicate and import the canonical implementation.
