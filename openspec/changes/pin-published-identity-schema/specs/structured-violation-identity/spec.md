...
canonical field names, and representative canonical field values. Each dimension SHALL additionally inspect at least one
...
catalog decision rather than silently bypassing the reaction. The reaction SHALL NOT freeze human finding
